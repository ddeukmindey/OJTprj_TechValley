...
('web-server-01',          'ap-southeast-1', 'MEDIUM', 'RUNNING', 45.5, 120.0, 1, NOW() - INTERVAL '30 days', NOW()),
('db-server-primary',      'ap-southeast-1', 'LARGE',  'RUNNING', 62.0, 250.0, 1, NOW() - INTERVAL '30 days', NOW()),
('db-server-high-cpu',     'ap-southeast-1', 'LARGE',  'RUNNING', 92.0, 250.0, 1, NOW() - INTERVAL '15 days', NOW()),
('app-server-error',       'ap-northeast-1', 'SMALL',  'ERROR',   10.0, 50.0,  1, NOW() - INTERVAL '10 days', NOW()),

-- Client 2 (XYZ Solutions, STANDARD)
('web-server-02',          'ap-southeast-1', 'SMALL',  'RUNNING', 38.0, 50.0,  2, NOW() - INTERVAL '20 days', NOW()),
('cache-server-stopped',   'ap-southeast-1', 'SMALL',  'STOPPED', 0.0,  50.0,  2, NOW() - INTERVAL '20 days', NOW() - INTERVAL '2 hours'),

-- Client 3 (DEF Innovations, BASIC) — có 1 instance dừng lâu để demo /long-stopped
('backup-server-longstop', 'ap-southeast-1', 'SMALL',  'STOPPED', 0.0,  50.0,  3, NOW() - INTERVAL '60 days', NOW() - INTERVAL '50 hours'),
('api-gateway-01',         'ap-southeast-1', 'MEDIUM', 'RUNNING', 55.0, 120.0, 3, NOW() - INTERVAL '5 days',  NOW());
